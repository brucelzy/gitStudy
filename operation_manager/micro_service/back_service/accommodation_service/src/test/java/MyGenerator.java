...
public class MyGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setActiveRecord(true);// 开启 activeRecord 模式 就是是不是开启自动增删改查功能
        globalConfig.setEnableCache(false);// XML 二级缓存
        globalConfig.setBaseResultMap(true);// XML ResultMap
        globalConfig.setBaseColumnList(true);// XML columList
        globalConfig.setAuthor("BruceLi");
        ...
        sourceConfig.setUrl("jdbc:mysql://192.168.20.23:3306/operate_manager?characterEncoding=utf8");
        ...
        injectionConfig.setFileOutConfigList(Collections.<FileOutConfig>singletonList(new FileOutConfig("/templates/mapper.xml.vm") {
            // /templates/mapper.xml.vm 是模板  baomodou包下
            // 自定义输出文件目录
            @Override
